    ...
    useEffect(() => {
        ...
        window.Header = () => {
            new window.google.translate.TranslateElement({
                pageLanguage: "en",
                includedLanguages: "af,am,ar,az,be,bg,bn,bs,ca,ceb,cs,cy,da,de,el,en,eo,es,et,eu,fa,fi,fr,ga,gl,gu,ha,haw,he,hi,hmn,hr,ht,hu,hy,id,ig,is,it,ja,jv,ka,kk,km,kn,ko,ku,ky,la,lb,lo,lt,lv,mg,mi,mk,ml,mn,mr,ms,mt,my,ne,nl,no,ny,pa,pl,ps,pt,ro,ru,rw,sd,si,sk,sl,sm,sn,so,sq,sr,st,su,sv,sw,ta,te,tg,th,tk,tl,tr,tt,ug,uk,ur,uz,vi,xh,yi,yo,zh-CN,zh-TW,zu"
            }, "ChangerLang");
            ...
            <nav className="navbar navbar-expand-lg fixed-top py-0 my-0 d-flex justify-content-center align-items-center" id="TopNavBar">
                <div className="container-fluid fw-medium text-uppercase" id="ToperNav">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav d-flex justify-content-around overflow-0 align-items-center MobileNav" id='MobileNav' style={{ height: '35px' }}>
                            ...
                            <li className="nav-item dropdown">
                                <Link className="nav-link dropdown-toggle" to="/OurCourses" role="button" onMouseEnter={fetchCourses} data-bs-toggle="dropdown">  <i className="fas fa-graduation-cap me-2" />Our Courses</Link>
                            ...
                            <li className="nav-item d-flex align-items-center">
                                <i className={`bi bi-translate text-white fs-5 me-2 d-lg-none me-4 ${isLanguageLoaded ? '' : 'bi-spin'}`}></i>
                                <span id="ChangerLang" title="Change the Language">
                                    {isLanguageLoaded}
                                </span>
                            </li>
                                ...
                                <h2 className="text-center fw-bolder text-primary"><b>{isAdmin ? 'Admin Login' : 'Student Login'}</b></h2>
                                {
                                    !islogin && (
                                        <>
                                            ...
                                            <div className="my-2">
                                                <input type="password" value={password} className="form-control rounded-3 border-0" placeholder='Password'
