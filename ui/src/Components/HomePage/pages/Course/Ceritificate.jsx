...
function Certificate() {
    ...
    return (
        <>
            <div className="container-fluid pt-3 diplomaTable">
                <CourseNav id='cerEle' className='bg-transparent' data='Certificate' searchQuery={searchQuery} setSearchQuery={setSearchQuery} />
                {filteredCourses.length === 0 ? (
                    ...
                    filteredCourses.map((course, index) => (
                        <div key={index} className="my-2 p-2" id='CourseEleChild'>
